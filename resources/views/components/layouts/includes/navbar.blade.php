<nav class="bg-gray-900 border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">
        <a href="" class="flex items-center">
            <img src="/tyler.png" class="h-32 p-2 rounded-full" alt="upb eshop logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">UPB E-shop</span>
        </a>
