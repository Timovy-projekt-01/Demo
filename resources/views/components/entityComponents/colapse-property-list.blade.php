    ...
    @if (isset($property))
        ...
        <ul x-show="open" @click="open = !open" class="list-none pl-4">
            @foreach ($property as $item)
                <li class="transition-transform duration-500 ease-in-out hover:underline border-b py-2 cursor-pointer transition duration-300 ease-in-out transform hover:translate-x-1"
