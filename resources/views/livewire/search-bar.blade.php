...
--}}
<div x-data="{isOpen: false}" class="relative flex flex-col justify-center p-5 align-middle shadow-lg w-full">
            ...
            @if ($searchTerm != '')
                <ul x-show="isOpen"
                    class="divide-y absolute z-10 bg-white border border-gray-300 rounded-md
                            shadow-md w-full flex flex-col overflow-auto max-h-60">
